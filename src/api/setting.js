...
//渠道管理列表
export function channelMannageApi (data) {
    return request({
...
//渠道管理获取地址
export function adressApi (data) {
    return request({
        url: '/sys_config',
        method: 'get',
        params: data
...
//渠道管理列表---保存
export function savaChanelApi (data) {
    return request({
...
//渠道管理列表---编辑
export function channelEditApi (id,data) {
    return request({
...
//视频类型设置
//视频类型---列表
export function videoTypeListApi (data) {
    return request({
        url: 'setting/vedio_cate/all',
        method: 'get',
        params: data
    })
}
//视频类型---添加
export function videoTypeAddApi (data) {
    return request({
        url: 'setting/vedio_cate/edit',
        method: 'post',
        data
    })
}
//视频类型---删除
export function videoTypeDeleteApi (data) {
    return request({
        url: 'setting/vedio_cate/del',
        method: 'post',
        data
    })
}
...
//拒绝理由----添加
export function refuseAddListApi (data) {
    return request({
        url: '/setting/violation/save',
        method: 'post',
        params: data
    })
}
//拒绝理由----列表
export function refuseListApi (data) {
    return request({
        url: '/setting/group_data',
        method: 'get',
        params: data
...
//拒绝理由----添加
export function refuseAddApi (data) {
    return request({
        url:'setting/group_data',
        method: 'post',
        data
...
//拒绝理由----编辑
export function refuseEditApi (id,data) {
    return request({
        url: `setting/group_data/${id}`,
        method: 'put',
        data
...
//拒绝理由----删除
export function refuseDelListApi (id) {
    return request({
        url: `setting/group_data/${id}`,
        method: 'delete',
    })
...
// 警告理由----列表
export function warnListApi (data) {
    return request({
        url: '/setting/group_data',
        method: 'get',
        params: data
...
//提现比例设置
//提现比例----添加
export function withdrawalAddApi (data) {
    return request({
        url: '/setting/withdrawal/save',
        method: 'post',
        params: data
    })
}
//提现比例---列表
export function withdrawalListApi (data) {
    return request({
        url: '/setting/withdrawal/index',
        method: 'get',
        params: data
    })
}
//提现比例----编辑
export function withdrawalEditApi (data) {
    return request({
        url: '/setting/withdrawal/update',
        method: 'post',
        params: data
    })
}
//提现比例----删除
export function withdrawalDelApi (id) {
    return request({
        url: `/setting/withdrawal/delete/${id}`,
        method: 'get',
    })
}
...
//支付类型----列表
export function payTypeListApi (data) {
    return request({
        url: '/setting/payment_method/index',
        method: 'get',
        params: data
    })
}
//支付类型----添加 
export function payTypeAddApi (data) {
    return request({
        url: '/setting/payment_method/save',
        method: 'post',
        params: data
    })
}
...
export function payTypeEditApi (data) {
    return request({
        url: '/setting/payment_method/update',
        method: 'post',
        params: data
    })
}
...
//支付类型----删除 
export function payTypeDelApi (id) {
    return request({
        url: `/setting/payment_method/delete/${id}`,
        method: 'get',
    })
}
////支付账号设置
...
//支付账号----列表
export function payAccountListApi (data) {
    return request({
        url: '/setting/account_number/index',
        method: 'get',
        params: data
    })
}
//支付账号----添加
export function payAccountAddApi (data) {
    return request({
        url: '/setting/account_number/save',
        method: 'post',
        params: data
    })
}
//支付账号----编辑
export function payAccountEditApi (data) {
    return request({
        url: '/setting/account_number/update',
        method: 'post',
        params: data
    })
}
//支付账号----删除 
export function payAccountDelApi (id) {
    return request({
        url: `/setting/account_number/delete/${id}`,
        method: 'get',
    })
}
/**
