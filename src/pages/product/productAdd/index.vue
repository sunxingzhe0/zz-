        ...
        <Card :bordered="false" dis-hover class="ivu-mt">
            ...
            <Form class="formValidate mt35" ref="formValidate" :rules="ruleValidate" :model="formValidate" :label-width="120" label-position="right" @submit.native.prevent>
                <Row :gutter="24" type="flex" v-show="currentTab === '1'">
                    ...
                    <Col span="24">
                        <FormItem label="商品关键字：" prop="keyword">
                    ...
                    <Col span="24">
                        <FormItem label="商品简介：" prop="keyword">
                    ...
                    <Col span="24" v-if="formValidate.is_sub.length">
                        ...
                        <FormItem label="批量设置：" v-if="formValidate.spec_type === 1">
                            <span v-if="formValidate.is_sub.indexOf(1) > -1">
                                一级返佣(元)：<InputNumber placeholder="请输入一级返佣" :min="0" class="columnsBox perW20" v-model="manyBrokerage"></InputNumber>
                                二级返佣(元)：<InputNumber placeholder="请输入二级返佣" :min="0" class="columnsBox perW20" v-model="manyBrokerageTwo"></InputNumber>
                            </span>
                            <span v-if="formValidate.is_sub.indexOf(0) > -1">
                                会员价(元)：<InputNumber placeholder="请输入会员价" :min="0" class="columnsBox perW20" v-model="manyVipPrice"></InputNumber>
                            </span>
