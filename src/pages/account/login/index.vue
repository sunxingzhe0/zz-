    ...
    >
      ...
      <div class="index_from page-account-container">
        <div class="page-account-top">
         ...
         <div class="shorVideo">短视频管理后台</div>
        <Form
          ref="formInline"
          :model="formInline"
          :rules="ruleInline"
...
<script>
import { AccountLogin, loginInfoApi,ossAdressApi } from "@/api/account";
...
export default {
  ...
  methods: {
    //获取图片地址
    getPicAdress(){
      ossAdressApi("video_oss_url").then(res=>{
        localStorage.setItem("ossUrl",res.msg)
        console.log(res,'other_oss_url');
      })
    },
    swiperData() {
      loginInfoApi()
        ...
        .catch((err) => {
          ...
          this.login_logo = require("@/assets/images/logo-small.png");
...
// /deep/.ivu-input-inner-container:hover{
// border: 0!important;
...
.icon {
  ...
  height:16px;
  display: flex;
  background-image: url('../../../assets/images/username.jpg');
