...
export default {
    ...
    children: [
        ...
        },
        {
            ...
            component: () => import("@/pages/user/inform/index")
        },
        {
            path: "collectionManage",
            name: `${pre}collectionManage`,
            meta: {
                auth: ["admin-user-user-collectionManage"],
                title: "合集管理"
            },
            component: () => import("@/pages/user/collectionManage/index")
        },
        {
            path: "user-generated",
            name: `${pre}generated`,
            meta: {
                auth: ["admin-user-generated"],
                title: "生成用户记录"
            },
            component: () => import("@/pages/user/generated/index")
        },
        {
            path: "level",
            name: `${pre}level`,
