...
export default {
    ...
    children: [
        ...
        {
            path: 'store_recharge/store_redeem',
            name: `${pre}store_redeem`,
            meta: {
                auth: ['marketing-store_redeem-index'],
                title: '兑换卡'
            },
            component: () => import('@/pages/marketing/storeRecharge/store_redeem')
        },
        {
            path: 'store_recharge/pay_list',
            name: `${pre}pay_list`,
            meta: {
                auth: ['marketing-store_redeem-index'],
                title: '充值列表'
            },
            component: () => import('@/pages/marketing/storeRecharge/pay_list')
        },
        {
            path: 'store_recharge/batch_list',
            name: `${pre}batch_list`,
            meta: {
                auth: ['marketing-store_redeem-index'],
                title: '批次列表'
            },
            component: () => import('@/pages/marketing/storeRecharge/batch_list')
        },

        {
            ...
            component: () => import('@/pages/marketing/audit/videoAudit')
        },
        {
            path: 'audit/commentAudit',
            name: `${pre}commentAudit`,
            meta: {
                title: '评论审核',
            },
            component: () => import('@/pages/marketing/audit/commentAudit')
        },
        {
            path: 'audit/withdrawAudit',
            name: `${pre}withdrawAudit`,
            meta: {
                title: '提现审核',
            },
            component: () => import('@/pages/marketing/audit/withdrawAudit')
        },
        {
            path: 'audit/ReportAudit',
            name: `${pre}ReportAudit`,
            meta: {
                title: '举报视频',
            },
            component: () => import('@/pages/marketing/audit/ReportAudit')
        },
        {
            path: 'audit/combineAudit',
            name: `${pre}combineAudit`,
            meta: {
                title: '合集审核',
            },
            component: () => import('@/pages/marketing/audit/combineAudit')
        },
