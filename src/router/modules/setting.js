...
export default {
  ...
  children: [
    ...
    },
    {
      ...
      name: `${pre}notice`,
      meta: {
        auth: ['setting-notice-config'],
        title: '公告'
      },
      component: () => import('@/pages/setting/notice/index')
    },
    {
      path: 'backend_config',
      name: `${pre}backend`,
      meta: {
        auth: ['setting-backend-config'],
        title: '后台配置'
      },
      component: () => import('@/pages/setting/backend/index')
    },
    {
      path: 'reasons_config',
      name: `${pre}refuseReasons`,
      meta: {
        auth: ['setting-system-config'],
        title: '拒绝理由设置'
      },
      component: () => import('@/pages/setting/refuseReasons/index')
    },
    {
      path: 'withdraw_config',
      name: `${pre}withdrawRatio`,
      meta: {
        auth: ['setting-system-config'],
        title: '提现比例设置'
      },
      component: () => import('@/pages/setting/withdrawRatio/index')
    },
    {
      path: 'paytype_config',
      name: `${pre}payType`,
      ...
      component: () => import('@/pages/setting/payType/index')
    },
    {
      path: 'payaccount_config',
      name: `${pre}payAccount`,
      meta: {
        auth: ['setting-system-config'],
        title: '支付账号设置'
      },
      component: () => import('@/pages/setting/payAccount/index')
    },
    {
      path: 'videoType_config',
      name: `${pre}videoType`,
      meta: {
        auth: ['setting-system-videoType'],
        title: '视频类型设置'
      },
      component: () => import('@/pages/setting/videoType/index')
    },
    {
      path: 'warnType_config',
      name: `${pre}warnType`,
      meta: {
        auth: ['setting-warn-config'],
        title: '警告理由设置'
      },
      component: () => import('@/pages/setting/warnType/index')
    },
   
        {
          path: 'turnDown_config',
          name: `${pre}turnDownType`,
          meta: {
            auth: ['setting-turnDown-config'],
            title: '禁用理由设置'
          },
          component: () => import('@/pages/setting/turnDownType/index')
        },
    {
