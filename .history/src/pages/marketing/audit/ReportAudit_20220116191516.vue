  ...
  <div class="video-page">
    ...
    <Modal v-model="detaiActionVisible"  width="860">
      ...
      <div slot="footer" style="text-align: center">
        ...
        <Button type="warning" v-if="detailMsgForm.report_status===1" @click="closeBannedClick">关闭此举报</Button>
        <Button type="success" v-if="detailMsgForm.report_status===1" @click="bannedClick">删除视频并封禁用户</Button>
        <Button type="success" v-if="detailMsgForm.report_status===1" @click="warnClick">删除视频并警告</Button>
      </div>
       <Spin size="large" fix v-if="spinShow2"></Spin>
    </Modal>
    <!-- 预览视频弹框 -->
    <Modal v-model="detaiVideoVisible"  width="500" :mask-closable="false" :closable="false">
      <div slot="header" style="text-align: center; font-size: 18px">
        预览视频
      </div>
  ...
  methods: {
    ...
    getDetailList(id) {
      ...
      reportVideoDetailApi({
        ...
        // this.detailData = this.detailData.forEach(item=>{
        //   item.img = item.img.forEach(item2=>{
        //       item2 = Setting.url(item2)
        //   })
